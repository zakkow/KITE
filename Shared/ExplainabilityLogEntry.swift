...
enum ExplainabilityLogStore {
    ...
    static func load() -> [ExplainabilityLogEntry] {
        ...
        guard let data = SharedStore.getSharedData(forKey: SharedStore.Keys.explainabilityLog),
    ...
    static func append(_ entry: ExplainabilityLogEntry) {
        ...
        DispatchQueue.global(qos: .utility).async {
            ...
            SharedStore.setSharedData(data, forKey: SharedStore.Keys.explainabilityLog)
        }
    }
}
